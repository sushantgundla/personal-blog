...
export default function AboutPage() {
  return (
    <div>
      <h1
        className="text-[30px] font-bold tracking-tight text-[var(--text-primary)] mb-6 animate-fade-up"
      ...
      <div className="animate-fade-up delay-1">
        <p className="text-[17px] leading-[1.85] text-[var(--text-secondary)] whitespace-pre-line mb-8">
          {siteConfig.bio}
        </p>
      </div>

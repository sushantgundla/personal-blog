    ...
    <div>
      ...
      <section className="mb-40">
        <div className="flex items-end justify-between mb-10">
          <div>
            <h2 className="font-headline text-4xl font-bold uppercase tracking-tight text-on-surface">
              AI Radar
            </h2>
          ...
          <div className="flex gap-2">
            <Link
              href="/radar"
              className="px-4 py-2 rounded-full bg-surface-container-high border border-outline-variant/30 font-label text-xs uppercase tracking-wider text-on-surface-variant hover:text-on-surface transition-colors"
            >
              Posts
            </Link>
            <Link
              href="/radar"
              className="px-4 py-2 rounded-full border border-outline-variant/20 font-label text-xs uppercase tracking-wider text-on-surface-variant hover:text-on-surface transition-colors"
            >
              Picks
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Latest Pulse */}
          <Link href="/radar" className="rounded-2xl border border-outline-variant/20 bg-surface-container p-8 hover:border-primary/30 transition-all group block">
          ...
          {/* Recent Picks */}
          <div className="rounded-2xl border border-outline-variant/20 bg-surface-container p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {articles.map((article) => (
              <Link
                ...
                className="group rounded-2xl border border-outline-variant/20 bg-surface-container p-8 hover:border-primary/30 transition-colors"
              >

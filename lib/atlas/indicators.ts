...
export const INDICATORS: IndicatorDef[] = [
  ...
  def("SI.DST.10TH.10", "Income share held by richest 10%", "%", "MONEY", "percent", null),
  ...
  def("TX.VAL.MRCH.CD.WT", "Goods exported", "current US$", "TRADE", "currency", null),
  def("TM.VAL.MRCH.CD.WT", "Goods imported", "current US$", "TRADE", "currency", null),
  def("BX.GSR.NFSV.CD", "Services exported", "current US$", "TRADE", "currency", null),
  def("BM.GSR.NFSV.CD", "Services imported", "current US$", "TRADE", "currency", null),
  def("BX.GSR.GNFS.CD", "Goods and services exported", "current US$", "TRADE", "currency", null),

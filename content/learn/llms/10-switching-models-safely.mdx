...
deeper:
  - { label: "Anthropic — model deprecations", href: "https://docs.anthropic.com/en/docs/about-claude/model-deprecations" }
...
2. **Run both models on it.** Same inputs, same temperature, same everything except the model id.

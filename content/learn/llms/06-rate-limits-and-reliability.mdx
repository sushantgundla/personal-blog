...
deeper:
  - { label: "Anthropic — rate limits", href: "https://docs.anthropic.com/en/api/rate-limits" }
  - { label: "Anthropic — errors and error handling", href: "https://docs.anthropic.com/en/api/errors" }

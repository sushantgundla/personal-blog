...
TOOLS = [...]          # your tool definitions - lesson 3 is about writing these
...
Read the two comments on the terminations. One is the model saying it is done. One is you saying it is done whether or not the model agrees. Both belong in every real loop, and lesson 4 is about the awkward fact that only the second one is dependable.
...
- **A cost ceiling.** Every step re-sends the whole growing transcript. Lesson 11 is entirely about the bill this produces.

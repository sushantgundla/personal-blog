...
Lesson 8 handed you a clean way to expose tools and was explicit that it does nothing about what those tools can reach. This is that lesson. It is defensive throughout: the goal is not to make the agent incapable of a bad decision, which is not on offer, but to make a bad decision boring.

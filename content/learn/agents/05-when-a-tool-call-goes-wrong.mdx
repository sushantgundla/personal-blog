...
**Stop and say so.** Partial result, the step that failed, the error. Lesson 4's `budget_exhausted` outcome and this one are siblings: both are honest endings, and both beat an invented answer.

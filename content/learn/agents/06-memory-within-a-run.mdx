...
**A task list.** The same idea with a second benefit: it gives you a progress signal you can read without a model call, which is what lesson 4's no-progress detector wants.

...
deeper:
  ...
  - { label: "Anthropic — mitigating jailbreaks and prompt injections", href: "https://docs.anthropic.com/en/docs/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks" }
